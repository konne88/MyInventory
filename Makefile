...
EXTRA_DIST =  rules.make configure Makefile.include Libs/WindowsBase.dll Libs/gdk-sharp.dll Libs/pango-sharp.dll Libs/glib-sharp.dll Libs/System.Core.dll Libs/gtk-sharp.dll
